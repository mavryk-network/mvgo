...
```bash
go install github.com/mavryk-network/tzgo/cmd/tzgen
```
...
```
//go:generate go run -mod=mod github.com/mavryk-network/tzgo/cmd/tzgen -name <name> -pkg <pkg> -address <addr> -out <file.go>
```
